...
func OpenTestConnection() (db gorm.DB, err error) {
	...
	case "mysql":
		...
		db, err = gorm.Open("mysql", "root:@/test?charset=utf8&strict=true&parseTime=True")
	case "postgres":
	...
	default:
		...
		db, err = gorm.Open("mysql", "root@tcp(localhost:4000)/test?strict=true&parseTime=True")
	}
	return
}
